    ...
    <>
      <header className="fixed top-0 left-0 right-0 z-50 bg-canvas/95 backdrop-blur-sm border-b border-charcoal/8">
        <div className="max-w-site mx-auto px-6 lg:px-12 h-16 flex items-center justify-between">
          ...
          {/* Hamburger */}
          <button
            className="md:hidden cursor-pointer p-2 text-charcoal hover:text-accent transition-colors"
      ...
      {/* Mobile fullscreen menu — sibling of header to avoid backdrop-filter stacking context */}
      {menuOpen && (
        <div
          className="md:hidden fixed inset-0 top-16 z-[9999] overflow-y-auto"
